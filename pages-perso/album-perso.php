...
<main style="padding: 60px 0 0 0;">
        ...
        <img style="width: 100%;" class="centre-div pose" src="../images/bandeaux/album-perso.webp" alt="Un bandeau présentant divers albums photos personnalisés" loading="lazy">
        <section class="section1" id="Album Photo">
        <div class="container">
            <h1 class="title-h3 centre-text">ALBUM PHOTO Personnalisé</h1>
