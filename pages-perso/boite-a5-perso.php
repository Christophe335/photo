...
<section class="section1" id="Boîte format A5">
    <div class="container">
        <h2 class="title-h3 centre-text">Boîte format A5 personnalisation par logo</h2>
...
<section class="section2" id="Boîte format A5 à recouvrir">
    <div class="container">
        <h2 class="title-h3 centre-text">Boîte format A5 personnalisation complète</br>Choix d'impression ou utilisez Cuir Vegan / finition Kashmir</h2>
