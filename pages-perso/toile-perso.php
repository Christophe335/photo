...
<main style="padding: 60px 0 0 0;">
        ...
        <img style="width: 100%;" class="centre-div pose" src="../images/bandeaux/photo-sur-toile-perso.webp" alt="Un bandeau présentant des impressions sur toile personnalisées" loading="lazy">
    <section class="section1" id="Impression sur Toile">
        <div class="container">
            
            <h1 class="title-h3 centre-text">IMPRESSION SUR TOILE Personnalisée</h1>
            <div class="ligne">
