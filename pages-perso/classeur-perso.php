...
<main style="padding: 60px 0 0 0;">
        <img style="width: 100%;" class="centre-div pose" src="../images/bandeaux/classeur-perso.webp" alt="Un bandeau présentant des finitions luxe pour livres photo">
   
    <section class="section1" id="Classeur">
    <div class="container">
        <h2 class="title-h3 centre-text">Classeur personnalisé - 2 ou 4 anneaux</h2>
