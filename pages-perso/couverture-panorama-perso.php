...
<main style="padding: 60px 0 0 0;">
        <img style="width: 100%;" class="centre-div pose" src="../images/bandeaux/panorama-perso.webp" alt="Un bandeau présentant des couvertures panoramiques personnalisées" loading="lazy">
<section class="section1" id="Couverture rigide Panorama">
    <div class="container">
        <h1 class="title-h3 centre-text">Couverture rigide Panorama</h1>
