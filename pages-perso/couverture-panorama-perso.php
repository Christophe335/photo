...
<main style="padding: 60px 0;">
    <!-- <div class="container">
        ...
        <img style="width: 100%;" class="centre-div pose" src="../images/bandeaux/panorama-perso.webp" alt="Un bandeau présentant des couvertures panoramiques personnalisées">
    <!-- <div class="container">
