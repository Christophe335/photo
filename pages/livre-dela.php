...
<main style="padding: 40px 0;">
    <div class="container">
        ...
        <img style="width: 100%;" class="centre-div pose" src="../images/bandeaux/dela-1.webp" alt="Un bandeau présentant des livres photo delà personnalisés">
    <div class="container">
        ...
        <div class="container">
            <div class="ligne">
                <div class="colonne-1 onleft">
                    <img class="centre-div" src="../images/produits/dela-1.webp" alt="Livre photo Dela fermé présentant la face avant avec sa personnalisation">
                </div>
                <div class="colonne-1">
                    <img class="centre-div" src="../images/produits/dela-open-1.webp" alt="Livre photo Dela, positionné ouvert montrant une double page avec des photos de paysages">
                </div>
                <div class="colonne-1 onright">
                    <img class="centre-div" src="../images/produits/dela-2.webp" alt="Livre photo Dela entre-ouvertprésentant la face avant avec sa personnalisation">
                </div>
            </div>
            </br>
