...
<main style="padding: 40px 0;">
   ...
   <section class="section1" id="Format A4 et A3">
        <div class="container">
            ...
            <div class="ligne">
                <div class="colonne-3 onleft">
                    <img class="centre-div" src="../images/produits/impression-toile-1.webp" width="200" height="auto" alt="Photo d'un cheval imprimé sur une toile de format A3">
                </div>
                <div class="colonne-3 onright">
                    <img class="centre-div" src="../images/produits/panneau photo-3.webp"  width="200" height="auto" alt="Photo d'un hôtel de luxe dans les tropiques imprimée sur un panneau rigide de format A3">
                </div>
            </div>  
                <div class="tableau-container">
                    <?php
