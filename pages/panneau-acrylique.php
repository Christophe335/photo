...
<main style="padding: 40px 0;">
    <div class="container">
        ...
        <img style="width: 100%;" class="centre-div pose" src="../images/bandeaux/panneau-acrylique-1.webp" alt="Un bandeau présentant des panneaux acryliques personnalisés">
    <div class="container">
        <p style="text-align: center; font-size: 18px; color: #666; margin-bottom: 40px;">
            Un rendu brillant et moderne avec nos panneaux en acrylique.
        </p>
    </div>
    <section class="section1" id="Panneaux Acrylique">
    <div class="container">
        <h2 class="title-h3 centre-text">Pannneau acrylique</h2>
    </div>
    <div class="ligne">
        <div class="colonne-5 onleft">
            <img class="centre-div" src="../images/produits/panneau-acrylic-1.webp" width="250px" height="250px" alt="Panneau en bamboo avec partie inférieur visible et sur le reste de la surface une vitre acrylique présentant une photo de famille"> 
        </div>
        <div class="colonne-6">
        ...
        <div class="colonne-5 onright">
            <img class="centre-div" src="../images/produits/panneau-acrylic-2.webp" width="350px" height="350px" alt="Panneau en bamboo recouvert d'une vitre acrylique présentant une photo de plusieurs surfeurs sur une plage"> 
        </div>
    </div>
        ...
        <div class="ligne">
        <div class="colonne-5 onleft">
            <img class="centre-div" src="../images/produits/peel-stick-panel-1.webp" width="300px" height="300px" alt="Panneau acrylique simple avec sytème autocollant présentant une photo de 3 femmes sur la plage"> 
        </div>
        <div class="colonne-6">
        ...
        <div class="colonne-5 onright">
            <img class="centre-div" src="../images/produits/peel-stick-panel-2.webp" width="300px" height="300px" alt="Panneau acrylique double avec sytème autocollant présentant une photo d'un menu de restaurant"> 
        </div>
    </div>
        <div class="tableau-container">
            <?php
...
<section class="section2" id="Panneaux Acrylique">
    <div class="container">
        <h2 class="title-h3 centre-text">Pannneau présentoir personnalisé</h2>
            <img class="centre-div" src="../images/produits/hard_cover_basic_display-1.webp" width="400px" height="250px" alt="Présentation du produit de personnalisation de panneau avec une feuille autocollante à imprimer"> 
