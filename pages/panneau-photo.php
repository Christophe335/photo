...
<main style="padding: 40px 0 0 0;">
    <div class="container">
        ...
        <img style="width: 100%;" class="centre-div pose" src="../images/bandeaux/panneau-photo-1.webp" alt="Un bandeau présentant des panneaux photo personnalisés" loading="lazy">
    ...
    <div class="ligne">
        <div class="colonne-5 onleft">
            <img class="centre-div" src="../images/produits/panneau photo-2.webp" width="250px" height="250px" alt="2 panneaux photo représentant une photo de famille et une photo de bébé" loading="lazy"> 
        </div>
        <div class="colonne-6">
        ...
        <div class="colonne-5 onright">
            <img class="centre-div" src="../images/produits/panneau photo-3.webp" width="200px" height="300px" alt="Panneau photo représentant la piscine d'un hotel de luxe dans un pays tropical" loading="lazy"> 
        </div>
    </div>
    ...
    <div class="ligne">
        <div class="colonne-5 onleft">
            <img class="centre-div" src="../images/produits/panneau photo-1.webp" width="300px" height="300px" alt="3 panneaux photo représentant une photo d'un couple', une photo de femme et une photo de bébé" loading="lazy"> 
        </div>
        <div class="colonne-6">
        ...
        <div class="colonne-5 onright">
            <img class="centre-div" src="../images/produits/panneau photo-4.webp" width="200px" height="300px" alt="Panneau photo représentant un diplôme" loading="lazy"> 
        </div>
    </div>
        <div class="tableau-container">
            <?php
